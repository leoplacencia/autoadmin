                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <div style="padding: 0 10px;text-align:justify"> 
                            ...
                            <p><i style="margin-right:10px" class="fa fa-map-marker"></i>Obispo Edwards, Santiago Chile.</p>
                            <div style="border: 1px dotted #eee; margin: 10px 0 10px 0"></div>
                            <p><i style="margin-right:10px" class="fa fa-phone"></i>+56 9 63223101</p>
                            <div style="border: 1px dotted #eee; margin: 10px 0 10px 0"></div>
                            <p><i style="margin-right:10px" class="fa fa-envelope"></i>placencia.leo@gmail.com</p>
                        </div>
                    </div>
                </div>
            </div>
